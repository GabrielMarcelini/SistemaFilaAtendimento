...
function adicionarElemento() {
    ...
    if (cpf === "" || nome === "") { // caso algum campo estiveja vazio 
      alert("Preencha todos os campos exigidos!!!");
      return
    }
      ...
      novoAtendimento.data = data;
      novoAtendimento.hora = hora;
...
function buscarCpf() {
    ...
    if (cpfEncontrado) {
      alert("O CPF digitado foi encontrado na fila!!! Posição: " + posicao);
    } else {
      alert("O CPF digitado não foi encontrado.");
    }
    limparCampos();
  }
//--------------------------------------------------------------------------------------------
...
//--------------------------------------------------------------------------------------------
//Funçao para limpar os valores de entrada de texto
